...
represent a battery pack with 12 cells. Apply a US06 drive cycle current to the
...
n_parallel = 2      # number of cells in parallel to make a module
n_series = 6        # number of battery modules in series to make a pack
...
ax.plot(data_us06.time, v_pack, color='k')
