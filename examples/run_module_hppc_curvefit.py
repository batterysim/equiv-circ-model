"""
Run curve fit of the HPPC battery module data. Print curve fit coefficients
for one time constant (OTC) and two time constant (TTC) functions. OTC
represents one RC pair and TTC represents two RC pairs.
"""
