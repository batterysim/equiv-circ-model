...
def view_cell_discharge_data():
    ...
    dis1c = CellDischargeData(params.datafiles['cell_discharge_1c'])
    dis2c = CellDischargeData(params.datafiles['cell_discharge_2c'])
    dis3c = CellDischargeData(params.datafiles['cell_discharge_3c'])

    f1c = params.datafiles['cell_temperature_1c']
    f2c = params.datafiles['cell_temperature_2c']
    f3c = params.datafiles['cell_temperature_3c']
    ...
    dis_1c = CellDischargeData.process(params.datafiles['cell_discharge_1c'])
    dis_2c = CellDischargeData.process(params.datafiles['cell_discharge_2c'])
    dis_3c = CellDischargeData.process(params.datafiles['cell_discharge_3c'])
    ...
    dis_only_1c = CellDischargeData.process_discharge_only(params.datafiles['cell_discharge_1c'])
    dis_only_2c = CellDischargeData.process_discharge_only(params.datafiles['cell_discharge_2c'])
    dis_only_3c = CellDischargeData.process_discharge_only(params.datafiles['cell_discharge_3c'])
